        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3">
              {/* Telegram placeholder - ждём правильный аккаунт */}
              <div className="w-8 h-8 bg-gray-800 rounded-lg flex items-center justify-center opacity-50 cursor-not-allowed" title="Telegram скоро будет">
